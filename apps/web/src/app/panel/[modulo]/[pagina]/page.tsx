...
// Página dinámica de un módulo. Por ahora es un placeholder: muestra la página
// habilitada y sus ejecutables configurados. La EJECUCIÓN real (correr el
// proc/query y mostrar la grilla) es la siguiente tanda.
