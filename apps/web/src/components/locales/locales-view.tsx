...
/* Hallmark · locales usa tarjetas móviles con agenda, tareas y acciones sin desborde. */
  ...
  return (
    <div className="w-full min-w-0">
      ...
      {locales.length === 0 ? (
        ...
        <>
          <div className="mt-4 grid gap-3 md:hidden" aria-label="Locales">
            {locales.map((l) => (
              <article
                key={l.id}
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 truncate text-xs font-medium text-brand-700 dark:text-brand-300">
                      {l.cliente.nombre}
                    </p>
                  </div>
          ...
          <div className="mt-4 hidden overflow-x-auto rounded-xl border border-line bg-surface-raised shadow-[0_10px_30px_rgba(var(--warm-shadow),0.05)] md:block">
