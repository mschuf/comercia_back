...
## Corpus Check
- 540 files · ~463,981 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3101 nodes · 6035 edges · 351 communities (166 shown, 185 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 37 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e29b1078`
...
## Communities (351 total, 185 thin omitted)
...
### Community 3 - ".rutaHoy"
Cohesion: 0.09
Nodes (28): aRadianes(), distanciaMetros(), AgendaDiaria, CandidataAgendaDiaria, CoordenadaRuta, MatrizRuta, OsrmRouteResponse, OsrmTableResponse (+20 more)

### Community 4 - "ActualizarTareaGlobalDto"
Cohesion: 0.07
Nodes (33): ActualizarTareaGlobalDto, AlcanceTareaDto, CrearTareaGlobalDto, PIPE, ArrayMaxSize, ArrayMinSize, ArrayUnique, IsArray (+25 more)

### Community 5 - "seguimiento-tareas-view.tsx"
Cohesion: 0.08
Nodes (30): tarea(), EquipoView(), ListaEquipoMovil(), ListaEquipoMovilProps, FiltroEstado, FiltrosSeguimientoTareas, ListaSeguimientoTareasMovil(), RespuestaSeguimiento (+22 more)
...
Cohesion: 0.12
Nodes (20): AdminPage(), enteroPositivo(), filtroRepositor(), filtrosTareas(), PaginaModulo(), textoConsulta(), valorConsulta(), VISTAS (+12 more)

### Community 15 - "App.tsx"
Cohesion: 0.12
Nodes (35): Aplicacion(), hayInternet(), styles, textoError(), PanelLogin(), PanelSeguimiento(), actualizarConsentimientoUbicacion(), contarUbicacionesPendientes() (+27 more)
...
Cohesion: 0.13
Nodes (12): LoginDto, IsString, Length, MaxLength, Transform, LoginSimDto, ArrayMaxSize, ArrayMinSize (+4 more)

### Community 21 - "dependencies"
Cohesion: 0.04
Nodes (48): dependencies, expo, expo-font, expo-image-picker, expo-location, expo-network, expo-notifications, expo-secure-store (+40 more)

### Community 22 - "ActualizarLocalDto"
Cohesion: 0.11
Nodes (28): ActualizarLocalDto, CrearLocalDto, ListarLocalesDto, ListarUsuariosAsignablesDto, IsBoolean, IsInt, IsISO8601, IsNumber (+20 more)

### Community 23 - "repositor.service.ts"
Cohesion: 0.07
Nodes (37): PaginacionDto, rangoPaginacion(), respuestaPaginada, IsInt, IsOptional, Max, Min, Type (+29 more)
...
### Community 27 - "notificaciones.service.ts"
Cohesion: 0.11
...
Cohesion: 0.11
Nodes (28): styles, styles, PantallaCarga(), styles, IconoNavegacion, PAGINACION_INICIAL, Seccion, SECCIONES (+20 more)

### Community 29 - "equipo.service.ts"
Cohesion: 0.09
Nodes (26): EstadoTareaEquipoDto, ListarRepositoresEquipoDto, ListarTareasEquipoDto, IsEnum, IsInt, IsOptional, IsString, Max (+18 more)

### Community 30 - "AuthService"
Cohesion: 0.14
Nodes (15): AuthController, ApiOperation, ApiTags, Body, Controller, Get, Post, Req (+7 more)
...
Cohesion: 0.12
Nodes (16): IdNotificacionDto, METADATA, PIPE, IsInt, Max, Min, Type, NotificacionesController (+8 more)
...
Cohesion: 0.20
Nodes (7): RequestConUsuario, JwtAuthGuard, Injectable, SuperadminGuard, Injectable, ListarNotificacionesDto, Query

### Community 39 - "impulsador/utils/programacion-visita.ts"
Cohesion: 0.15
Nodes (22): NovedadVisitaTareaDto, FrecuenciaProgramacionVisita, ProgramacionVisitaCalculo, ProgramacionVisitaDto, VisitaEquipoLocalDto, VisitaEquipoUltimaVisitaDto, coincideFrecuencia(), compararFecha() (+14 more)
...
### Community 42 - "visitas-view.tsx"
Cohesion: 0.09
Nodes (32): consultaFechas(), KpisVisitas(), ListaKpisMovil(), MisMarcacionesView(), EstadoFoto, FOTO_MIMETYPES, NovedadReportada(), WidgetFoto() (+24 more)

### Community 43 - "AccesoOperacionesCampoService"
Cohesion: 0.16
Nodes (3): AccesoOperacionesCampoService, Injectable, UsuarioAsignableOperacionesDto

### Community 44 - "locales.service.ts"
Cohesion: 0.16
Nodes (10): filtrosBusquedaUsuario(), UsuarioOperacionesCampo, LocalDetalleDto, LocalDto, UsuarioAsignable, aLocalDto(), LocalConRelaciones, LocalesService (+2 more)

### Community 45 - "proximidad.ts"
Cohesion: 0.16
Nodes (18): visita(), plugins, AgendaProximidad, DatosGeocerca, DatosUbicacion, detenerGeocercas(), distanciaMetros(), fechaLocalActual() (+10 more)
...
Cohesion: 0.09
Nodes (17): PanelLayout(), AuthShell(), BrandMark(), BotonTema(), LoginForm(), PanelContext, PanelData, PanelProvider() (+9 more)
...
Cohesion: 0.11
Nodes (28): DIAS, EditorProgramacionVisita(), fechaHoy(), programacionInicial(), VisitaActiva(), claseProximaVisita(), ListaProgramacionMovil(), VisitasView() (+20 more)

### Community 51 - "mobile/src/lib/api.ts"
Cohesion: 0.21
Nodes (17): PanelImpulsador(), apiUrl, obtenerApiUrl(), actualizarTareaVisita(), iniciarSesionMovil(), iniciarSesionMovilConSim(), mensajeError(), obtenerAgendaHoy() (+9 more)
...
### Community 53 - "ZonasController"
Cohesion: 0.16
Nodes (12): ApiTags, Body, Controller, Delete, Get, Param, Patch, Post (+4 more)

### Community 54 - ".usuario"
Cohesion: 0.07
Nodes (27): LocalMapaDto, MapaDatosDto, TerritorioDto, ZonaDto, aLocalMapaDto(), TerritoriosController, ApiTags, Body (+19 more)
...
### Community 61 - "acceso-plataforma.service.ts"
Cohesion: 0.23
Nodes (5): AccesoPlataformaService, Injectable, AccesoModulos, UsuarioConAcceso, rolVe()

### Community 62 - "cola-marcaciones.ts"
Cohesion: 0.15
Nodes (19): leerUbicacion(), mensajeError(), ErrorApi, finalizarVisita(), finalizarVisitaMovil(), iniciarVisita(), cantidadMarcacionesPendientes(), ejecutar() (+11 more)
...
### Community 76 - "mapa.service.ts"
Cohesion: 0.14
Nodes (12): MapaController, ApiTags, Controller, Get, Req, UseGuards, LocalParaMapa, MapaService (+4 more)
...
Cohesion: 0.11
Nodes (5): ModuloMenu, MiPlataformaService, Injectable, PrismaService, Injectable
...
### Community 110 - "acceso-operaciones-campo.service.ts"
Cohesion: 0.22
Nodes (9): MODULOS_GESTION_CAMPO, MODULOS_OPERACION_CAMPO, MODULOS_OPERATIVOS_CAMPO, PAGINAS_REPOSITOR, paginasOperacionEquivalentes(), SELECT_TAREA_LOCAL, TareaLocalFila, SELECT_TAREA_GLOBAL (+1 more)
...
### Community 142 - "RepositorController"
Cohesion: 0.31
...
Cohesion: 0.12
Nodes (16): redondear1Decimal(), FrecuenciaVisitaDto, VisitaResumenDto, duracionVisitaMinutos(), fechaMarcacionDispositivo(), aVisitaResumenDto(), LocalEquipo, nombreCompleto() (+8 more)

### Community 327 - "UsuariosService"
Cohesion: 0.30
...
### Community 344 - "HealthController"
Cohesion: 0.25
...
## Knowledge Gaps
- **910 isolated node(s):** `$schema`, `collection`, `sourceRoot`, `deleteOutDir`, `name` (+905 more)
...
- **Why does `PrismaService` connect `PrismaService` to `app.module.ts`, `ActualizarTareaGlobalDto`, `clientes.service.ts`, `admin-empresas.service.ts`, `roles.service.ts`, `repositor.service.ts`, `kpis-visitas.service.ts`, `zonas.service.ts`, `AsignarModuloDto`, `notificaciones.service.ts`, `equipo.service.ts`, `AuthService`, `VisitasService`, `RequestConUsuario`, `impulsador/utils/programacion-visita.ts`, `ModulosService`, `AccesoOperacionesCampoService`, `locales.service.ts`, `.usuario`, `plataforma.controller.ts`, `acceso-plataforma.service.ts`, `ubicaciones.service.ts`, `mapa.service.ts`, `EjecutablesService`, `HealthController`, `auth.service.ts`, `acceso-operaciones-campo.service.ts`, `visitas.service.ts`?**
...
- **Why does `prisma` connect `kpis-visitas.service.ts` to `dependencies`, `repositor.service.ts`?**
